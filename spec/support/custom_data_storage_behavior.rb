shared_examples_for 'custom_data_storage' do
  ...
  context 'should respond to' do
    it '#has_key?' do
      expect(custom_data_storage.custom_data.has_key? "created_at").to be_true
    end

    it '#include?' do
      expect(custom_data_storage.custom_data.include? "created_at").to be_true
    end
    ...
    it '#keys' do
      ...
      expect(custom_data_storage.custom_data.keys.map {|key| key.to_s.camelize :lower}).to eq(custom_data_storage.custom_data.properties.keys)
    end
